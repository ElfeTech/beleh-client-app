    ...
    <div className="profile-sidebar-container">
      ...
      <div className="profile-sidebar-content">
        {Object.entries(groupedItems).map(([category, items]) => (
          <div key={category} className="profile-sidebar-section">
            <div className="profile-sidebar-section-title">{category}</div>
            <div className="profile-sidebar-menu">
              {items.map((item) => (
                <button
                  key={item.id}
                  className={`profile-sidebar-item ${activeSection === item.id ? 'active' : ''}`}
        ...
        <div className="profile-sidebar-section">
          <button className="profile-sidebar-signout" onClick={onSignOut}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
