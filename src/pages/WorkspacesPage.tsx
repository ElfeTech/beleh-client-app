...
export function WorkspacesPage() {
    ...
    return (
        <div className={`workspaces-page ${isSettingsEmbed ? 'workspaces-page--settings settings-page-section' : ''}`}>
            {isSettingsEmbed ? (
                ...
                <div className="workspaces-header">
                    <div className="header-content">
                        ...
                        <button type="button" className="btn-gradient-primary create-workspace-button" onClick={() => setShowCreateModal(true)}>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <div className="ws-settings-env__controls">
                        <div className="ws-settings-field">
                            ...
                            <div className="ws-settings-search">
                                <Search className="ws-settings-search__icon" size={18} strokeWidth={2} aria-hidden />
                                <input
                ...
                <>
                    ...
                    {loading && workspaces.length === 0 ? (
                        ...
                        <div className="workspaces-empty">
                            ...
                            {!searchQuery && (
                                <button type="button" className="btn-gradient-primary empty-create-btn" onClick={() => setShowCreateModal(true)}>
                                    Create Workspace
                                </button>
                            )}
                        </div>
