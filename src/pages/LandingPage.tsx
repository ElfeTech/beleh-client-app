...
export default function LandingPage() {
  ...
  const testimonials = [
    {
      quote:
        'Beleh transformed how we make decisions. What took our analysts days now takes seconds.',
      author: 'Sarah Chen',
    ...
    {
      quote:
        'Finally, our marketing team can explore data without waiting for engineering support.',
    ...
    {
      quote:
        "The AI understands context perfectly. It's like having a data analyst available 24/7.",
  ...
  const features = [
    {
      ...
      description:
        'Natural language queries powered by advanced AI that understands your business context.',
    ...
    },
    {
      ...
      description:
        'Beautiful charts and graphs generated automatically. Export and share with one click.',
    ...
    },
    {
      ...
      description:
        'Bank-level encryption, SOC 2 compliant, and complete data isolation between workspaces.',
    ...
    },
    {
      ...
      description:
        'Get answers in milliseconds, not minutes. Handle datasets of any size effortlessly.',
    ...
    <div className="landing-page-v2">
        ...
        <div className="hero-light-container">
          ...
          <div className="hero-light-content">
            ...
            <p className="hero-light-subtitle">
              ...
              insights no SQL, no expertise, no dashboards, no complexity.
            </p>
                    ...
                    <div className="chat-message-demo ai">
                      ...
                      <div className="chat-bubble-demo ai-bubble">
                        <p className="ai-response-text">
                          Based on your Q3 data, here are your top 5 products by revenue:
                        </p>
                        <div className="demo-chart">
                          <div
                            className="demo-bar"
                            style={{ '--bar-height': '100%' } as React.CSSProperties}
                          >
                            <span className="bar-label-demo">Product A</span>
                          </div>
                          <div
                            className="demo-bar"
                            style={{ '--bar-height': '78%' } as React.CSSProperties}
                          >
                            <span className="bar-label-demo">Product B</span>
                          </div>
                          <div
                            className="demo-bar"
                            style={{ '--bar-height': '65%' } as React.CSSProperties}
                          >
                            <span className="bar-label-demo">Product C</span>
                          </div>
                          <div
                            className="demo-bar"
                            style={{ '--bar-height': '52%' } as React.CSSProperties}
                          >
                            <span className="bar-label-demo">Product D</span>
                          </div>
                          <div
                            className="demo-bar"
                            style={{ '--bar-height': '40%' } as React.CSSProperties}
                          >
        ...
        <div className="section-container-v2">
          ...
          <div className="problem-grid-v2">
            <div className="problem-card-v2">
              ...
              <p>
                Traditional BI tools require extensive setup before you see any value. Time is
                money.
              </p>
            ...
            <div className="problem-card-v2">
              ...
              <p>
                Waiting for data analysts creates delays. Decisions get postponed. Opportunities
                missed.
              </p>
              <div className="problem-stat">
          ...
          <div className="steps-container">
            ...
            <div className="step-connector">
              <svg viewBox="0 0 100 20" fill="none">
                <path
                  d="M0 10 H85 L75 5 M85 10 L75 15"
              ...
              {[
                {
                  ...
                  beleh: 'Minutes',
                  other: 'Weeks',
                  icon: ComparisonIcons.time,
                },
                {
                  label: 'Query Interface',
                  beleh: 'Natural Language',
                  other: 'SQL / Complex UI',
                  icon: ComparisonIcons.message,
                },
                {
                  label: 'Setup Required',
                  beleh: 'Zero',
                  other: 'Extensive',
                  icon: ComparisonIcons.settings,
                },
                {
                  label: 'Learning Curve',
                  beleh: 'None',
                  other: 'Weeks of Training',
                  icon: ComparisonIcons.book,
                },
                {
                  label: 'For Non-Technical Users',
                  beleh: 'Perfect',
                  other: 'Difficult',
                  icon: ComparisonIcons.users,
                },
                {
                  label: 'Cost',
                  beleh: 'Affordable',
                  other: 'Expensive',
                  icon: ComparisonIcons.dollar,
                },
              ].map((row) => (
      ...
      <section className="final-cta-v2">
        ...
        <div className="cta-content-v2">
          <h2 className="cta-title-v2">Ready to Transform Your Data?</h2>
